...
Use this as a guide, not a strict instruction that must be followed. Pick a direction when it helps the page; adapt fonts, colors, assets, and details to the brand, content, audience, and technical constraints. Commit to one clear intent instead of blending many aesthetics into a generic result.
...
Identify the emotional goal: edgy, luxe, calm, industrial, playful.

Pick fonts first, then colors that suit the fonts' character.

Decide on a single signature move: checkerboard stripe, neon glow, magazine pull-quote. Everything else supports it.
