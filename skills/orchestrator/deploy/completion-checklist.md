# Completion Checklist: Deploy

Before using `summary.response.md`, confirm:

- [ ] Working local webpage summary is present.
- [ ] Final human UI approval is present.
- [ ] Release approval is present.
- [ ] Deployment target is known.
- [ ] Production domain or preview target is known.
- [ ] Required environment variables are set or marked not needed.
- [ ] Rollback expectation is captured.
