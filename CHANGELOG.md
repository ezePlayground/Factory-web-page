...
- Added static mockup artifact rules and approval record conventions.
- Replaced vague template placeholders with clearer bracketed prompts.
- Updated handoff state after GitHub remote setup and push.

## Initial Framework

- Created markdown-first Web Page Factory Framework.
- Added five primary orchestrator skills: `new-idea`, `discovery`, `plan`, `implementation`, and `deploy`.
